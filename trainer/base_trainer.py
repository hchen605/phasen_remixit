...
class BaseTrainer:
    def __init__(self, config, resume: bool, model, optimizer, scheduler):
        ...
        self.student_pretrained = config["trainer"]["student_pretrained"]
    ...
    def metrics_visualization(self, noisy_list, clean_list, enhanced_list, epoch):
        ...
        print('SDR_clean_denoise: ', np.mean(sisdr_clean_denoise), 'SDR_clean_noisy: ',np.mean(sisdr_clean_noisy))
